    ...
    (function ($) {
        ...
        $.widget("ui.lazyload", {
            ...
            _init: function () {
                ...
                var self = this, o = self.options, el = self.element, ops =
this.options;
                ...
                (function (o, url, actn, args) {
                    ...
                    if(url && actn) {
                        ...
                        if(ops.before && $.isFunction(ops.before))
eval(ops.before());
                        ...
                        $.ajax({
                            ...
                            error: function(xhr, status, error) {
                                ...
                                $(o).html('Error processing
request.').addClass("error");

                                if(ops.error && $.isFunction(ops.error))
eval(ops.error());
                            ...
                            complete: function(html){
                                ...
                                if(ops.complete && $.isFunction(ops.complete))
eval(ops.complete());
                            ...
                            success: function(html) {
                                ...
                                if(ops.success && $.isFunction(ops.success))
eval(ops.success());
                        ...
                        console.log("You must provide a data-controller and a
data-action on the object.")

                    }

                })($(el).attr("data-target"), $(el).attr("data-controller"),
"action=" + $(el).attr("data-action"), $(el).attr("data-params"));
...
support for the following:
    ...
    $("#one").lazyload({before: [function], complete: [function], success:
...
them and hopefully they can be leveraged or rewritten to support your needs.
   ...
   [1]: http://docs.jquery.com/UI_Developer_Guide#The_widget_factory (jQuery
Widgets)
